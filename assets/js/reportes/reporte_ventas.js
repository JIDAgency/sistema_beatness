(async () => {
    get_ventas_numero_del_mes();
})();

async function get_ventas_numero_del_mes() {

    // Llamar a la API con la función Fetch que es nativa de JavaScript.
    const get_respuesta = await fetch("../reportes/grafica_numero_de_ventas_por_mes");
    ...
    const grafica = document.querySelector("#chart-ventas");
