...
$(document).ready(function(){
    ...
    $("#mes_a_consultar").change(function () {
        ...
        url = method_call+"get_lista_de_ventas_del_dia_para_fd_con_permisos/"+mes_a_consultar;
        reload_table();
...
function generar_datos_de_reporte_de_ventas(mes_a_consultar_var) {
    if (mes_a_consultar_var == null) {
        ...
        $.ajax({
            url: method_call+"get_numeros_de_ventas_del_dia_para_fd_con_permisos",
            type: "GET",
            dataType:'json',
        ...
        $.ajax({
            url: method_call+"get_numeros_de_ventas_del_dia_para_fd_con_permisos/"+mes_a_consultar_var,
            type: "GET",
            dataType:'json',
            success: function(data) {
                $.each(data, function(index,item){
