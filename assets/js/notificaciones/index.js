...
$(document).ready( function(){
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url" : method_call+"obtener_list_index",
            "type" : 'POST'
        },
        "columns": [
            {"data": "id"},
...
function modal_enviar_notificacion_segmento_usuarios_sin_compras_hace_dos_meses(id){

    $('#modal_enviar_notificacion_segmento_usuarios_sin_compras_hace_dos_meses').modal('show');
