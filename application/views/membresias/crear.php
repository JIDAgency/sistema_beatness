					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Nueva membresía</h4>
							</div>
							<div class="card-content">
								<div class="card-body">
									...
									<?php echo form_open('membresias/crear', array('class' => 'form form-horizontal', 'id' => 'forma-crear-membresia')); ?>
									<div class="form-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-md-5">
														<input type="text" name="tipo" class="form-control" placeholder="Tipo" value="<?php echo set_value('tipo'); ?>">
													</div>
												</div>
											</div>
										</div>
