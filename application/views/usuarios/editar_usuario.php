															...
															<div class="col-md-7">
																<select name="rol_id" class="form-control">
																	...
																	<?php foreach ($roles as $rol) : ?>
																		<option value="<?php echo $rol->id; ?>" <?php echo set_select(
																													'rol_id',
																													$rol->id,
															...
															<div class="col-md-7">
																<select name="sucursal_id" class="form-control">
																	...
																	<?php foreach ($sucursales as $sucursal) : ?>
																		<option value="<?php echo $sucursal->id; ?>" <?php echo set_select(
																															'sucursal_id',
																															$sucursal->id,
												...
												<div class="row">
													...
													<div class="col-lg-12 col-md-12 col-sm-12">
														<div class="form-group row">
															...
															<div class="col-md-5">
																<input autocomplete="off" type="text" class="form-control" name="no_telefono" placeholder="No. de Teléfono" value="<?php echo set_value('no_telefono') == false ? $usuario_a_editar->no_telefono : set_value('no_telefono'); ?>">
															</div>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-12 col-md-12 col-sm-12">
														<div class="form-group row">
															...
															<div class="col-md-9">
																<input type="text" name="fecha_nacimiento" class="date-dropper form-control" placeholder="Seleccione una fecha" value="<?php echo set_value('fecha_nacimiento') == false ? date('d/m/Y', strtotime($usuario_a_editar->fecha_nacimiento)) : date('d/m/Y', strtotime(set_value('fecha_nacimiento'))); ?>">
															</div>
														</div>
													</div>
													<div class="col-lg-12 col-md-12 col-sm-12">
