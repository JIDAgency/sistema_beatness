        ...
        <div class="content-header row">
			...
			<div class="content-header-right col-md-6 col-12 mb-2">
				<div class="form-group float-md-right">
					<a class="btn btn-secondary btn-min-width mr-1 mb-1" href="<?php echo site_url('usuarios/crear_usuario') ?>">
						<i class="ft-plus white"></i> Nuevo Usuario
					</a>
						...
						<div class="card">
							...
							<div class="card-content p_dt">
								<div class="card-body">
									...
									<table id="tabla-clientes" class="table table-striped table-bordered compact" cellspacing="0">
										<thead>
											<tr>
												<th>ID</th>
