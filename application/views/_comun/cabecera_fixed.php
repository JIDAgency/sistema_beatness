                        ...
                        <ul class="nav navbar-nav float-right">
                            ...
                            <li class="dropdown dropdown-user nav-item">
                                <a class="nav-link" href="#" data-toggle="dropdown">
                                    <span><?php date_default_timezone_set('America/Mexico_City'); setlocale(LC_TIME,"es_ES.UTF-8"); echo strftime("%a-%d-%b-%Y"); ?></span>
                                </a>
                            </li>
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <?php if (es_administrador()): ?>
                        ...
                        <!--
                            ...
                            <li class="nav-item"><a class="nav-link <?php //echo isset($menu_ventas_activo) ? 'active' : ''; ?>" href="<?php //echo site_url('ventas'); ?>"><i class="icon-wallet"></i><span>Ventas</span></a></li>
                        -->
                    <?php endif;?>
