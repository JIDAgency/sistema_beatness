				...
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="<?php echo site_url('instructores/index') ?>">Instructores</a>
							</li>
							<li class="breadcrumb-item active">Crear nuevo instructor
							</li>
						</ol>
					</div>
				</div>
					...
					<div class="col-12">
						<div class="card no-border">
							<div class="card-header">
								<h4 class="card-title">Nuevo instructor</h4>
							</div>
							<div class="card-content">
								<div class="card-body">
									<?php echo form_open_multipart('instructores/crear', array('class' => 'form form-horizontal', 'id' => 'forma-crear-instructor')); ?>
									<div class="form-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group row">
													<label for="apellido_paterno" class="col-md-3 label-control"> Apellido paterno</label>
													<div class="col-md-9">
										...
										<div class="form-actions right">
											<a href="<?php echo site_url('instructores/index'); ?>" class="btn btn-secondary btn-sm">Cancelar</a>
