				...
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Editar instructor
							</li>
						</ol>
					</div>
				</div>
					...
					<div class="col-12">
						<div class="card no-border">
							<div class="card-header">
								<h4 class="card-title">Editar instructor</h4>
							</div>
							<div class="card-content">
								<div class="card-body">
									<?php echo form_open_multipart('instructores/editar', array('class' => 'form form-horizontal', 'id' => 'forma-editar-instructor')); ?>
