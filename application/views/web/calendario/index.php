...
<body class="horizontal-layout bg-calendario horizontal-menu horizontal-menu-padding 2-columns menu-expanded p-1 pt-3" data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
    ...
    <div class="app-content content center-layout p-1">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="card card-transparent no-border">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Semana <?php echo date('d/M/Y', strtotime($fecha_lunes)) . ' - ' . date('d/M/Y', strtotime($fecha_domingo)); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="base-tab2" data-toggle="tab" aria-controls="tab2" href="#tab2" aria-expanded="false">Semana <?php echo date('d/M/Y', strtotime($fecha_lunes_siguente)) . ' - ' . date('d/M/Y', strtotime($fecha_domingo_siguente)); ?></a>
                                    </li>
                                </ul>
