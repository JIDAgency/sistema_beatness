                    ...
                    <div class="col-12">
                        <div class="card no-border">
                            ...
                            <div class="card-header">
                                <h4 class="card-title"><?php echo $pagina_titulo.' #'.$clase_row->id; ?></h4>
                            </div>
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="row match-height mb-2">
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <img class="img-fluid" src="<?php echo base_url('subidas/perfil/'.$clase_row->usuario_nombre_imagen_avatar); ?>" width='200' alt="">
                                        </div>
                                    </div>

                                    <div class="row match-height">
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <p><b>Instructor: </b><?php echo $clase_row->instructor; ?></p>
                                        </div>
                                    </div>

                                    <div class="row match-height">
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <p><b>Horario: </b><?php echo date('d/m/Y h:i a', strtotime($clase_row->inicia)); ?></p>
                                        </div>
                                    </div>

                                    <div class="row match-height">
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <p><b>Identificador: </b><?php echo $clase_row->identificador; ?></p>
                                        </div>
                                    </div>

                                    <div class="row match-height">
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            <p><b>Cupos: </b><?php echo $clase_row->cupo.'/'.$clase_row->reservado; ?></p>
                                        </div>
                                    </div>
                                                    ...
                                                    if ($lugar->nombre_usuario) {
                                                        ...
                                                        foreach ($usuarios->result() as $usuario){
                                                            if ($lugar->nombre_usuario == $usuario->id) {
                                                                echo $i. ' - Lugar: '.$lugar->no_lugar.' |  Cliente: '.$lugar->nombre_usuario.' - '.$usuario->nombre_completo.' '.$usuario->apellido_paterno.' '.$usuario->apellido_materno.' |  Calzado: '.$usuario->talla_calzado;
                                                                echo '<br>';
                                                            }
                                                        }
                                            ...
                                            <div class="col-xl-6 col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group">
													<div class="row">
														...
														<div class="col-lg-12">
															<input type="hidden" class="form-control" name="id" id="id" placeholder="ID" value="<?php echo $clase_row->id; ?>" readonly required>
                                        ...
                                        <div class="row match-height mt-3">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group float-md-right">
                                                    ...
                                                    <button type="submit" class="btn btn-outline-secondary btn-min-width mr-1"><i class="fa fa-check-circle"></i>&nbsp;Enviar</button>
                                                </div>
                                            </div>
                                        </div>
