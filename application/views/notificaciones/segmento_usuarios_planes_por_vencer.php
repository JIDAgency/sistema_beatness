                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                            ...
                                            <table class="table display nowrap table-striped table-bordered scroll-horizontal table-hover" name="table" id="table">
                                                ...
                                                <tbody>
                                                    <?php foreach ($asignaciones_list as $usuario_key => $usuario_row) : ?>
                                                        <?php // Supongamos que $usuario_row es un objeto con los atributos fecha_activacion y vigencia_en_dias
                                                        $fecha_activacion = new DateTime($usuario_row->fecha_activacion);
                                                        $vigencia_en_dias = $usuario_row->vigencia_en_dias;

                                                        // Sumamos los días de vigencia a la fecha de activación
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $usuario_row->nombre . '&nbsp;#' . $usuario_row->id . '&nbsp;Clases:&nbsp;[' . $usuario_row->clases_usadas . '/' . $usuario_row->clases_incluidas . ']'; ?></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
