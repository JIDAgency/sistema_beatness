				...
				<section class="flexbox-container">
					<div class="col-12 d-flex align-items-center justify-content-center">
						<div class="col-md-6 col-10 box-shadow-2 p-0">
							...
							<?php echo form_open('usuario/bienvenido/seleccionarplan', array('class' => 'form-horizontal')); ?>
								<div class="card-header border-0">
										<img class="img-fluid mx-auto d-block" width="100" src="<?php echo base_url(); ?>app-assets/images/bienvenido/b3-logo-azul.png" alt="">
								</div>

								<div class="card-content">
									<div class="card-body">
										<img class="img-fluid mx-auto d-block" src="<?php echo base_url(); ?>app-assets/images/bienvenido/registro-bienvenida-info-01.png" alt="">
									</div>
									<div class="card-body">
										<button type="submit" class="btn btn-outline-info btn-block"><i class="ft-unlock"></i> Comenzar</button>
									</div>
								</div>
							<?php echo form_close(); ?>
							</div>
