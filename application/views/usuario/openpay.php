        ...
        <div class="pymnts">
            <form action="#" method="POST" id="payment-form">
                ...
                <div class="pymnt-itm card active">
                    ...
                    <input type="text" class="form-control" name="nombre" placeholder="Nombre" value="<?php echo set_value('nombre') == false ? $plan_a_comprar->nombre : set_value('nombre'); ?>">
                    <br>
                    <input type="text" class="form-control" name="costo" placeholder="Costo" value="<?php echo set_value('costo') == false ? $plan_a_comprar->costo : set_value('costo'); ?>">
                    <br>
