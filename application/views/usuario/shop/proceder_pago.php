<div class="app-content container center-layout mt-2 b3-ux-v2-fondo">
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <?php echo form_open($controlador, array('class' => 'form form-horizontal needs-validation card-form p-2 bg-white card', 'id' => 'forma-proceder-pago', 'novalidate' => '')); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 col-12 mb-2">
                        <h4 class="text-uppercase grey lighten-2 mb-1"><strong>Registra un método de pago</strong></h4>

                        <?php if ($tarjetas_registradas_list->num_rows() != 0): ?>

                            <div class="text-center mb-2">
                            <?php if ($tarjetas_registradas_list->num_rows() == 1): ?>
                                <p class="grey lighten-2">Usted ya tiene <strong><?php echo $tarjetas_registradas_list->num_rows(); ?></strong> tarjeta registrada</p>
                            <?php else: ?>        
                                <p class="grey lighten-2">Usted ya tiene <strong><?php echo $tarjetas_registradas_list->num_rows(); ?></strong> tarjetas registradas</p>
                            <?php endif; ?>
                            <span class="grey lighten-2"><u>Ir a seleccionar</u></span>
                            </div>

                            <h6 class="card-subtitle line-on-side text-muted text-center font-small-3">
                                <span class="grey lighten-2">ó</span>
                            </h6>

                        <?php endif; ?>

                        <input type="hidden" class="form-control" name="id" id="id" placeholder="Plan seleccionado" value="<?php echo $suscripcion_row->id; ?>" readonly="readonly">
                        <input type="hidden" class="form-control" name="tarjeta" id="tarjeta" placeholder="Tarjeta seleccionada" value="<?php echo $tarjeta; ?>" readonly="readonly">
                        ...
                        <div class="mb-2">
                            <div class="form-group row">
                                <label for="nombre_tarjeta" class="col-md-4 grey lighten-2">Nombre en la tarjeta <span>*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control card-name" name="name" id="nombre_tarjeta" placeholder="" value="<?php echo set_value('nombre_tarjeta'); ?>" disabled readonly="readonly">
                        ...
                        <div class="mb-2">
                            <div class="form-group row">
                                <label for="numero_tarjeta" class="col-md-4 grey lighten-2">Número de tarjeta <span>*</span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control card-number" name="number" id="numero_tarjeta" placeholder="" value="<?php echo set_value('numero_tarjeta'); ?>" maxLength="19" disabled readonly="readonly">
                                    <div class="invalid-feedback">
                        ...
                        <div class="mb-2">
                            <div class="form-group row">
                                <label for="codigo_verificacion" class="col-md-4 grey lighten-2">Código de verificación <span>*</span></label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control card-cvc" name="cvc" id="codigo_verificacion" placeholder="" value="<?php echo set_value('codigo_verificacion'); ?>" maxLength="4" disabled readonly="readonly">
                                    <div class="invalid-feedback">
                        ...
                        <div class="mb-2">
                            <div class="form-group row">
                                <label for="fecha_expiracion" class="col-md-4 grey lighten-2">Fecha de vencimiento <span>*</span></label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control card-expiry" name="expiry" id="fecha_expiracion" placeholder="" value="<?php echo set_value('fecha_expiracion'); ?>" maxLength="7" disabled readonly="readonly">
                                    <div class="invalid-feedback">
                    ...
                    <div class="col-xl-4 col-md-6 col-12 mb-2">
                        <h4 class="text-uppercase  mb-1"><strong>¡Activa tu plan ahora!</strong></h4>
                        
                        <?php if ($tarjetas_registradas_list->num_rows() != 0): ?>

                            <div class="d-block my-2">

                                <p class="text-justify">Seleccionar tarjeta: <span>*</span></p>

                                <?php foreach ($tarjetas_registradas_list->result() as $tarjeta_registrada_row): ?>
                                    <div class="custom-control custom-radio mb-1">
                                        <input id="metodo_pago_<?php echo $tarjeta_registrada_row->id; ?>" name="metodo_pago" type="radio" class="custom-control-input" <?php echo set_radio('metodo_pago', $tarjeta_registrada_row->id, $tarjeta_registrada_row->id == $tarjeta); ?> value="<?php echo $tarjeta_registrada_row->id; ?>" required="">
                        ...
                        <div class="form-actions center">
                            <button type="submit" class="btn btn-info btn-min-width mr-1 mb-1">Pagar</button>
                        </div>
