										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" readonly="true" id="myInput" class="form-control" name="identificador" placeholder="Identificador" value="<?php echo set_value('identificador'); ?>">
													</div>
												</div>
											</div>
											<div class="col-md-6">
												...
												<div class="form-group row">
													...
													<div class="col-md-5">
														<input type="date" id="mySelect3" name="inicia_date" class="form-control" placeholder="Indique la fecha"
														 value="<?php echo set_value('inicia_date'); ?>">
													</div>
													<div class="col-md-4">
														<input type="time" id="mySelect4" name="inicia_time" class="form-control" placeholder="Indique la hora" value="<?php echo set_value('inicia_time'); ?>">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-md-4">
														<input type="number" min="0" pattern="^[0-9]+" class="form-control" name="cupo" placeholder="Cupo" value="<?php echo set_value('cupo'); ?>">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-md-4">
														<input type="number" min="0" pattern="^[0-9]+" name="intervalo_horas" class="form-control" placeholder="Duración en hrs." value="<?php echo set_value('intervalo_horas'); ?>">
													</div>
												</div>
											</div>
											<div class="col-md-6">
