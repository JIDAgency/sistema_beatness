...
<body class="horizontal-layout horizontal-menu horizontal-menu-padding 1-column menu-expanded blank-page blank-page bg-full-screen-image"
						...
						<div class="col-md-4 col-10 box-shadow-2 p-0">
							<div class="card border-grey border-lighten-3 px-2 py-2 m-0">
								...
								<div class="card-content">
									<div class="card-body">
										<?php echo form_open('cuenta/olvido_contrasena', array('id' => 'forma-olvido-contrasena', 'class' => 'form-horizontal')); ?>
										<fieldset class="form-group position-relative has-icon-left">
											<input type="email" class="form-control form-control-lg input-lg" name="correo" placeholder="Email" value="<?php echo set_value('correo'); ?>">
											<div class="form-control-position">
												<i class="ft-mail"></i>
											</div>
										</fieldset>
										<button type="submit" class="btn btn-outline-info btn-lg btn-block"><i class="ft-unlock"></i> Recuperar
											contraseña</button>
										<?php echo form_close(); ?>
									</div>
								</div>
								<div class="card-footer border-0 font-small-3">
									<p class="float-sm-left text-center"><a href="<?php echo site_url('cuenta/iniciar_sesion'); ?>" class="card-link">Iniciar
											sesión</a></p>
									<p class="float-sm-right text-center text-muted">¿Es nuevo? <a href="<?php echo site_url('cuenta/registrar'); ?>"
										 class="card-link">Cree
											una cuenta</a></p>
								</div>
							</div>
						</div>
