...
class Planes extends MY_Controller
{
    ...
    public function load_lista_de_todos_los_planes_para_datatable()
    {
        ...
        foreach ($planes_list as $plan_row) {
            ...
            $result[] = array(
                ...
                "es_ilimitado" => ucfirst($plan_row->es_ilimitado),
                "es_primera" => ucfirst($plan_row->es_primera),
                "es_estudiante" => ucfirst($plan_row->es_estudiante),
                "es_empresarial" => ucfirst($plan_row->es_empresarial),
                "pagar_en" => ucfirst($plan_row->pagar_en),
    ...
    public function crear()
    {
        ...
        try {
            ...
            if ($this->form_validation->run() == false) {
                ...
                if (isset($_FILES) && $_FILES['url_infoventa']['error'] == '0') {
                    ...
                    if (!is_dir($config['upload_path'])) {
                        ...
                        throw new Exception('La carpeta de carga no existe.');
                    }
            ...
            $this->mensaje_del_sistema("MENSAJE_ERROR", $e, site_url($data['controlador']));
        }
    }
    ...
    public function editar($id = null)
    {
        ...
        try {
            ...
            if (!$plan_a_editar) {
                ...
                // redirect('/planes/index');
                throw new Exception('El plan que intenta editar no existe.');
            }
